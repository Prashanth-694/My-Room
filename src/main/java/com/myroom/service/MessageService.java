...
//	String[] phoneNumberArr= {"+91 84989 57066", "+91 89784 86561","+91 84990
//	46226","+91 77028 85451","+91 82975 69247","+91 63059 15200"};
...
//		Message.creator(new PhoneNumber(phoneNumber), new PhoneNumber(twilioNumber), userName + " has purchased "
//				+ prodName + " for the amount of " + amount + " rupees at \n" + date + ". to view click below \n" + url)
//				.create();
//		// }
//
//	}
